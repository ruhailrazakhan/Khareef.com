...
<div class="mobileBar">
  <button class="mbBtn active" id="btnList">List</button>
  <button class="mbBtn" id="btnMap">Map</button>
</div>
...
<script async
  src="https://maps.googleapis.com/maps/api/js?key=<?= htmlspecialchars(GOOGLE_API_KEY) ?>&callback=initMap">
</script>
</body>
</html>
